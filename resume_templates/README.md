...
This folder contains filled, previewable resume templates.
...
`templates/` contains renderer templates with placeholders such as `{{ profile }}`.

`resume_templates/` contains filled example resumes that can be opened directly in a browser.
